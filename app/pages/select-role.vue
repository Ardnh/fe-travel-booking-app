...
<template>
    <UMain
        class="flex items-center justify-center min-h-screen bg-gradient-to-br from-[color:var(--omni-teal)]/5 to-[color:var(--omni-teal-dark)]/5"
    >
        <div class="w-full max-w-2xl px-6 py-12">
            <div class="text-center mb-12">
                ...
                <p class="text-xl text-slate-300">
                    Choose the role that best describes you to continue
                </p>
            </div>
            ...
            <div class="grid gap-8 md:grid-cols-2">
                <!-- Daily User Option -->
                <NuxtLink
                    v-for="item in userProfile?.roles ?? []"
                    :to="mapRolesToRoute(item).route"
                ...
                >
                    <div
                        class="w-16 h-16 mb-6 flex items-center justify-center bg-white/10 rounded-xl"
                    >
                        <svg
                    ...
                    <h3 class="text-xl font-semibold text-white mb-2">
                        {{ mapRolesToRoute(item).name }}
                    </h3>
                    <p class="text-slate-300 text-center">
                        Manage your personal HR tasks, time off, and payroll
                    </p>
                ...
                >
                    ...
                    >
                        ...
                        >
                            <path
                                d="M12 8c4.418 0 8 3.582 8 8v8H4v-8c0-4.418 3.582-8 8-8zm0 14c-3.315 0-6-2.685-6-6h12c0 3.315-2.685 6-6 6z"
                            />
                        </svg>
                    </div>
                    <h3 class="text-xl font-semibold text-white mb-2">
                    ...
                    <p class="text-slate-300 text-center">
                        Manage your team, payroll, and business operations
                    </p>
                    <div class="mt-6 w-full flex justify-center">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
