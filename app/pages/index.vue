...
<template>
    <UMain>
        ...
        <section class="relative px-8 pt-28 pb-36 flex flex-col items-center text-center overflow-hidden">
            ...
            <!-- Badge -->
            <div
                class="relative z-10 flex items-center gap-2 rounded-full border border-cyan-700/40 bg-cyan-950/30 px-4 py-1.5 text-xs font-medium text-cyan-300 tracking-wide uppercase backdrop-blur-sm mb-8"
            >
                    ...
                    <div class="w-11 h-11 rounded-2xl bg-linear-to-br from-cyan-900/60 to-cyan-800/30 border border-cyan-700/30 flex items-center justify-center mx-auto mb-5">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.6" stroke="currentColor" class="w-5 h-5 text-cyan-300">
                            <path
                                stroke-linecap="round"
                                stroke-linejoin="round"
                                d="M16.5 18.75h-9m9 0a3 3 0 013 3h-15a3 3 0 013-3m9 0v-3.375c0-.621-.503-1.125-1.125-1.125h-.871M7.5 18.75v-3.375c0-.621.504-1.125 1.125-1.125h.872m5.007 0H9.497m5.007 0a7.454 7.454 0 01-.982-3.172M9.497 14.25a7.454 7.454 0 00.981-3.172M5.25 4.236c-.982.143-1.954.317-2.916.52A6.003 6.003 0 007.73 9.728M5.25 4.236V4.5c0 2.108.966 3.99 2.48 5.228M5.25 4.236V2.721C7.456 2.41 9.71 1.25 12 1.25c2.29 0 4.544.41 6.75 1.471V4.237c0-.892-.59-1.68-1.439-1.923a6.007 6.007 0 00-5.02-2.487 6.003 6.003 0 00-5.28 5.676zM12 2.25c-1.29 0-2.54.09-3.763.26a8.005 8.005 0 00-3.993 4.166M12 2.25c1.29 0 2.54.09 3.763.26a8.005 8.005 0 013.993-4.166"
                            />
                        </svg>
                    </div>
