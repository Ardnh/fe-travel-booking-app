...
<template>
    ...
    <div v-if="!vendor" class="flex justify-center py-12">
        <UIcon
            ...
            class="animate-spin text-gray-400 text-2xl"
        />
    </div>
            ...
            <div class="flex items-start justify-between flex-wrap gap-3">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <div class="flex items-center gap-2 mb-1">
                            ...
                            <UBadge
                                :color="
                                    vendor.is_verified ? 'success' : 'warning'
                                "
                                variant="soft"
                            >
                                {{
                        ...
                        <p class="text-sm text-gray-500">
                            {{ vendor.description }} &nbsp;·&nbsp; Berdiri sejak
                            {{ vendor.founded_year }}
                        </p>
                    </div>
                </div>
                <div class="flex gap-2">
                    <UButton
                        ...
                        @click="navigateTo('/dashboard/vendor/edit')"
                    >
                        Edit
                    </UButton>
                    <UButton
                        ...
                        @click="navigateTo('/dashboard/vendor/verify')"
                    >
                        Ajukan Verifikasi
                    </UButton>
                </div>
                    ...
                    <p>
                        {{
                            new Intl.DateTimeFormat("id-ID", {
                                dateStyle: "medium",
                                timeStyle: "short",
                            }).format(new Date(vendor.updated_at))
                        }}
                    </p>
                </div>
                <div>
                        ...
                        {{
                            vendor.deleted_at
                                ? new Intl.DateTimeFormat("id-ID", {
                                      dateStyle: "medium",
                                      timeStyle: "short",
                                  }).format(new Date(vendor.deleted_at))
                                : "—"
                        }}
                    </p>
                </div>
