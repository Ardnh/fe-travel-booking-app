...
const destinationPools = computed(() => {
    if (destinationMode.value === "city")
        return poolsByCity[destinationCity.value] ?? [];
            ...
            <div class="mx-auto flex max-w-3xl flex-col gap-4">
                ...
                <UCard variant="outline">
                    ...
                    >
                        ...
                        {{ (poolsByCity[destinationCity] ?? []).length }} pool
                        aktif di {{ destinationCity }}.
                    </p>
                </UCard>
                ...
                >
                    ...
                    <p class="mb-3.5 text-sm text-primary/80">
                        ...
                        {{ destinationPools.length }} pool tujuan ×
